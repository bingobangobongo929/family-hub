...
export const da: Translations = {
  ...
  routines: {
    title: 'Rutiner',
    subtitle: 'Byg sunde vaner med daglige rutiner',
    pageSubtitle: 'Byg sunde vaner med daglige rutiner',
    noRoutines: 'Ingen rutiner endnu',
    noRoutinesHint: 'Opret din første rutine for at bygge sunde vaner',
    ...
    routineTitle: 'Rutine navn',
    routineName: 'Rutine navn',
    routineTitlePlaceholder: 'f.eks. Sengetidsrutine',
    type: 'Type',
    morning: 'Morgen',
    evening: 'Sengetid',
    ...
    startsAt: 'Starter kl.',
    starsReward: 'Stjerne belønning',
    participants: 'Deltagere',
    assignedTo: 'Tildelt til',
    everyone: 'Alle',
    steps: 'Trin',
    addStep: 'Tilføj trin',
    stepTitle: 'Trin titel',
    stepTitlePlaceholder: 'f.eks. Børst tænder',
    stepDuration: 'Varighed (minutter)',
    done: 'Færdig!',
    start: 'Start rutine',
    reset: 'Nulstil',
    nextStep: 'Næste',
    complete: 'Fuldfør',
    allComplete: 'Alt færdigt!',
    allDoneGreat: 'Godt klaret!',
    haveGreatDay: 'Hav en vidunderlig dag!',
    sweetDreams: 'Sov godt!',
    wellDone: 'Godt klaret!',
    stepComplete: '{name} fuldførte {step}',
    routineComplete: '{name} fuldførte rutinen!',
    earnedStars: 'Optjente {count} stjerner!',
    tapToComplete: 'Tryk når færdig',
    waitingFor: 'Venter på {names}',
    everyoneDone: 'Alle er færdige med dette trin!',
  ...
  settings: {
    ...
    memberColor: 'Farve',
    memberAvatar: 'Avatar',
    starsEnabled: 'Optjen Stjerner',
    starsEnabledDesc: 'Optjen point fra pligter og rutiner',
  ...
  history: {
    ...
    unchecked: 'afkrydsede',
    redid: 'gengjorde',
    allRoutines: 'Alle rutiner',
    noActivityForDate: 'Ingen aktivitet registreret for denne dag',
    clickToViewLog: 'Klik for at se aktivitetslog',
    stepBreakdown: 'Trinoversigt',
    minutes: 'minutter',
    hoursShort: 't',
    minutesShort: 'm',
