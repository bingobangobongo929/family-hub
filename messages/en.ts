...
export const en = {
  ...
  routines: {
    title: 'Routines',
    subtitle: 'Build healthy habits with daily routines',
    pageSubtitle: 'Build healthy habits with daily routines',
    noRoutines: 'No routines yet',
    noRoutinesHint: 'Create your first routine to build healthy habits',
    ...
    routineTitlePlaceholder: 'e.g., Bedtime Routine',
    type: 'Type',
    morning: 'Morning',
    evening: 'Bedtime',
    custom: 'Custom',
    ...
    stepTitlePlaceholder: 'e.g., Brush teeth',
    stepDuration: 'Duration (minutes)',
    done: 'Done!',
    start: 'Start Routine',
    reset: 'Reset',
    nextStep: 'Next',
    ...
    allDoneGreat: 'Great job!',
    haveGreatDay: 'Have a wonderful day!',
    sweetDreams: 'Sweet dreams!',
    wellDone: 'Well done!',
    stepComplete: '{name} completed {step}',
    routineComplete: '{name} finished the routine!',
    earnedStars: 'Earned {count} stars!',
    tapToComplete: 'Tap when done',
    waitingFor: 'Waiting for {names}',
    everyoneDone: 'Everyone finished this step!',
  ...
  settings: {
    ...
    memberColor: 'Color',
    memberAvatar: 'Avatar',
    starsEnabled: 'Track Stars',
    starsEnabledDesc: 'Earn points from chores and routines',
  ...
  history: {
    ...
    noActivityForDate: 'No activity recorded for this day',
    clickToViewLog: 'Click to view activity log',
