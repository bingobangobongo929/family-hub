            ...
            {binStatuses.map(bin => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`${titleSize} font-medium text-slate-700 dark:text-slate-200 mt-1`}>
                    {bin.shortName}
                  </span>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`font-medium text-slate-700 dark:text-slate-200 truncate ${size === 'small' ? 'text-xs' : 'text-sm'}`}>
                    {bin.shortName}
                  </p>
