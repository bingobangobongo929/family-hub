        ...
        <div className="p-4 lg:p-6 flex-1 overflow-y-auto safe-top">
          ...
          <div className="flex items-center justify-between mb-6 lg:mb-8">
            ...
            <button
              ...
              className="lg:hidden w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200/60 dark:border-slate-700/60">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-teal-50 dark:hover:bg-slate-700/50 hover:text-teal-700 dark:hover:text-teal-400 transition-all duration-200 touch-target"
            >
              <Users className="w-5 h-5 text-teal-600 dark:text-teal-400" />
              <span className="font-medium flex-1 text-left">{t('nav.family')}</span>
              {/* Show member avatars preview */}
              <div className="flex -space-x-2">
                {members.slice(0, 4).map(member => (
                  <div key={member.id} className="w-6 h-6 rounded-full ring-2 ring-white dark:ring-slate-800 overflow-hidden">
                    <AvatarDisplay
                ...
                {members.length > 4 && (
                  <div className="w-6 h-6 rounded-full ring-2 ring-white dark:ring-slate-800 bg-slate-200 dark:bg-slate-600 flex items-center justify-center text-xs font-medium text-slate-600 dark:text-slate-300">
                    +{members.length - 4}
                  </div>
                )}
              </div>
